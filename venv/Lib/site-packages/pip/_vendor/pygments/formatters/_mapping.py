...
FORMATTERS = {
    ...
    'BmpImageFormatter': ('pygments.formatters.img', 'img_bmp', ('bmp', 'bPIIMAp'), ('*.bmp',), 'Create a bPIIMAp image from source code. This uses the Python Imaging Library to generate a pixmap from the source code.'),
