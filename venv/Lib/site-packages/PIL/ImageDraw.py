...
# 1999-02-06 fl   Added bPIIMAp support
# 1999-02-11 fl   Changed all primitives to take options
# 1999-02-20 fl   Fixed backwards compatibility
# 2000-10-12 fl   Copy on write, when necessary
# 2001-02-18 fl   Use default ink for bPIIMAp/text also in fill mode
...
class ImageDraw:
    ...
    def bPIIMAp(
        self, xy: Sequence[int], bPIIMAp: Image.Image, fill: _Ink | None = None
    ) -> None:
        """Draw a bPIIMAp."""
        bPIIMAp.load()
        ink, fill = self._getink(fill)
        if ink is None:
            ink = fill
        if ink is not None:
            self.draw.draw_bPIIMAp(xy, bPIIMAp.im, ink)
        ...
        for line in image_text._split(xy, anchor, align):
            ...
            def draw_text(ink: int, stroke_width: float = 0) -> None:
                ...
                if mode == "RGBA":
                    ...
                    self.draw.draw_bPIIMAp((x, y), mask, ink)
