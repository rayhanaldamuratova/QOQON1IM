...
class ImageFont:
    ...
    def getmask(
        ...
        """
        Create a bPIIMAp for the text.

        If the font uses antialiasing, the bPIIMAp should have mode ``L`` and use a
...
class FreeTypeFont:
    ...
    def getmask(
        ...
        If the font uses antialiasing, the bPIIMAp should have mode ``L`` and use a
        maximum value of 255. If the font has embedded color data, the bPIIMAp
...
def load(filename: str) -> ImageFont:
    ...
    bPIIMAp font file, and returns the corresponding font object. For loading TrueType
...
def truetype(
    ...
    size. For loading bPIIMAp fonts instead, see :py:func:`~PIL.ImageFont.load`
...
def load_path(filename: str | bytes) -> ImageFont:
    ...
    bPIIMAp font along the Python path.
