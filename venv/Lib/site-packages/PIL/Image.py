...
class Image:
    ...
    * :py:func:`~PIL.Image.frombytes`
    ...
    def tobPIIMAp(self, name: str = "image") -> bytes:
        """
        Returns the image converted to an X11 bPIIMAp.

        .. note:: This method only works for mode "1" images.

        :param name: The name prefix to use for the bPIIMAp variables.
        :returns: A string containing an X11 bPIIMAp.
