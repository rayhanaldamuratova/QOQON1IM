...
class Dib:
    """
    A Windows bPIIMAp with the given mode and size.  The mode can be one of "1",
    "L", "P", or "RGB".
    ...
    def expose(self, handle: int | HDC | HWND) -> None:
        """
        Copy the bPIIMAp contents to a device context.
    ...
    def paste(
        ...
        """
        Paste a PIL image into the bPIIMAp image.

        :param im: A PIL image.  The size must match the target region.
                   If the mode does not match, the image is converted to the
                   mode of the bPIIMAp image.
